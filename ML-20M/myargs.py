...
def get_args():
    ...
    parser.add_argument('--learning_rate', type=float, default=0.00005, help='learning rate')#0.000005
    ...
    parser.add_argument('--neighbor_sample_number', type=int, default=10, help='neighbor sample number')
    ...
    parser.add_argument('--all_item_number', type=int, default=27278, help='item number in ML-20M')
